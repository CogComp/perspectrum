...
FILE_PATH = {
    ...
    "stance_model_dir": "../model/stance-roberta-base",

    # Relevance
    "relevance_data": "../data/dataset/perspective_relevance/",
    "relevance_model_dir": "../model/relevance-roberta-base",

    # Evidence
    "evidence_data": "../data/dataset/perspective_evidence/",
    "evidence_model_dir": "../model/evidence-roberta-base",

    # Equivalence
    "equivalence_data": "../data/dataset/perspective_equivalence/",
    "equivalence_model_dir": "../model/equivalence-roberta-base",
}
